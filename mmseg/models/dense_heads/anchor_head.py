...
from mmseg.core import (anchor_inside_flags, build_anchor_generator,
...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def _get_bboxes(self,
        ...
        for cls_score, bbox_pred, anchors in zip(mlvl_cls_scores,
            ...
            from mmseg.core.export import get_k_for_topk
        ...
        if torch.onnx.is_in_onnx_export() and with_nms:
            from mmseg.core.export import add_dummy_nms_for_onnx
        ...
        if self.use_sigmoid_cls:
            ...
            # remind that we set FG labels to [0, num_class-1] since mmseg v2.0
            # BG cat_id: num_class
