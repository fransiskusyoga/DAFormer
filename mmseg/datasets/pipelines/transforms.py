...
class RandomFlipPanUDA(object):
    ...
    def __init__(self, prob=None, direction='horizontal'):
        if isinstance(prob, list):
            ...
            raise ValueError('probs must be None, float, '
                             'or list of float')
        self.prob = prob
    ...
    def __call__(self, results):
        ...
        if 'flip' not in results:
            ...
            if isinstance(self.prob, list):
                ...
                prob_list = [single_ratio] * (len(direction_list) -
                                                    1) + [non_prob]
