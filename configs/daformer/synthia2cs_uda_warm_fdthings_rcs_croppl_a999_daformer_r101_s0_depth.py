_base_ = [
    ...
    '../_base_/models/daformer_depth_sepaspp_r101.py',
...
name = 'synthia2cs_uda_warm_fdthings_rcs_croppl_a999_daformer_r101_s0_depth'
exp = 'basic'
name_dataset = 'synthia2cityscapes'
name_architecture = 'daformer_depth_sepaspp_r101'
name_encoder = 'r101'
