_base_ = [
    ...
    '../_base_/models/daformer_sepaspp_pvtb5.py',
    # Synthia->Cityscapes Data Loading
    '../_base_/datasets/uda_synthia_to_cityscapes_500x500.py',
...
name = 'synthia2cs_backbone_pvtb5'
exp = 'basic'
name_dataset = 'synthia2cityscapes'
name_architecture = 'daformer_sepaspp_pvtb5'
name_encoder = 'mitb5'
